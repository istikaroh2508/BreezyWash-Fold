                     ...
                     <div class="row-input">
                        ...
                        <div class="col-form m-1">
                           <div class="form-grup">
                              ...
                              <select name="jenis_paket_ck[]" id="pilih_paket1">
                              ...
                              <div class="form-grup">
                              <label for="pilih_paket1">Pilih Paket 2</label>
                              <select name="jenis_paket_ck[]" id="pilih_paket2">
                                 <option>-- Pilih Jenis Paket --</option>
                                 <?php foreach ($data_ck as $ck): ?>
                                    <option>
                                       <?= $ck['nama_paket_ck'] ?>
                              ...
                              <div class="form-grup">
                              <label for="pilih_paket1">Pilih Paket 3</label>
                              <select name="jenis_paket_ck[]" id="pilih_paket3">
                                 <option>-- Pilih Jenis Paket --</option>
                                 <?php foreach ($data_ck as $ck): ?>
                                    <option>
                                       <?= $ck['nama_paket_ck'] ?>
