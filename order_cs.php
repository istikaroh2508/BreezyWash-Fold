               ...
               <div class="card-body">
                  <form action="" method="post">
                     <div class="row-input">
                        ...
                        <div class="col-form m-1">
                           <div class="form-grup">
                              <label for="pilih_paket1">Pilih Paket 1</label>
                              <select name="jenis_paket_cs[]" id="pilih_paket1">
                           ...
                           <div class="form-grup">
                              <label for="pilih_paket2">Pilih Paket 2</label>
                              <select name="jenis_paket_cs[]" id="pilih_paket2">
                                 <option>-- Pilih Jenis Paket --</option>
                                 <?php foreach ($data_cs as $cs): ?>
                                    <option>
                                       <?= $cs['nama_cs'] ?>
                           ...
                           <div class="form-grup">
                              <label for="pilih_paket3">Pilih Paket 3</label>
                              <select name="jenis_paket_cs[]" id="pilih_paket3">
                                 <option>-- Pilih Jenis Paket --</option>
                                 <?php foreach ($data_cs as $cs): ?>
                                    <option>
                                       <?= $cs['nama_cs'] ?>
                           ...
                           <div class="form-grup">
                              <label for="kuantitas1">Jumlah Order Per/Pcs </label>
                              <input type="number" name="jml_pcs" placeholder="Jumlah Order (Pcs)" autocomplete="off"
                                 id="kuantitas">
                           </div>
