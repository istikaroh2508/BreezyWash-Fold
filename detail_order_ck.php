...
<?php if (isset($_POST['bayar_ck'])) : ?>
   <script>
      window.location="http://localhost:8080/BreezyWash&Fold/detail_order/detail_ck/bayar.php?or_ck_number=<?=$no_ck?>";
   </script>
<?php endif ?>
                  ...
                  <form action="" method="post">
                     ...
                     <table class="tb-detail_customer">   
                        ...
                        <tr>
                           <th>Alamat</th>
                           <td>
                              <textarea name="alamat_ck" disabled class="txt-area"><?=$data['alamat_ck']?></textarea>
                           </td>
                        </tr>
                        ...
                        <tr>
   <th>Jenis Paket</th>
   <td><input type="text" name="jenis_paket_ck1" disabled value="<?php echo isset($_POST['jenis_paket_ck1']) ? $_POST['jenis_paket_ck1'] : ''; ?>"></td>
   <td></td>
   <td><input type="text" name="jenis_paket_ck2" disabled value="<?php echo isset($_POST['jenis_paket_ck2']) ? $_POST['jenis_paket_ck2'] : ''; ?>"></td>
   <td></td>
   <td><input type="text" name="jenis_paket_ck3" disabled value="<?php echo isset($_POST['jenis_paket_ck3']) ? $_POST['jenis_paket_ck3'] : ''; ?>"></td>
</tr>
                     ...
                     <div class="details">
                        ...
                        <p class="lead">
                           <textarea name="keterangan_ck" disabled class="txt-area"><?=$data['keterangan_ck']?></textarea>
                        </p>
                     </div>
