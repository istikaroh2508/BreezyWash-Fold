...
<html>
<head>
	<title>Breezy Wash & Fold | Dashboard</title>
	<link rel="stylesheet" href="<?=url('_assets/css/style.css')?>">
	<link rel="shortcut icon"src="<?=url('_assets/img/logo1.svg')?>" type="image/x-icon">
</head>
<body>
	...
	<header>
		<nav>
			<div class="logo">
				<a href="<?=url()?>">
					<img src="<?=url('_assets/img/logo/logo1.png')?>" alt="Rumah Laundry Logo">
				</a>
			</div>
			<ul class="nav-menu">
				<li>
		...
		<div id="nav-mini">
			...
			<a href="<?=url('laporan.php')?>" class="link-nav">Laporan Bulanan</a>
		</div>
	</header>